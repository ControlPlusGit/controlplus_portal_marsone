...
void poe_dado_display (unsigned char);
...
void niblle_dado_display (unsigned char);

void niblle_com_display (unsigned char);

void minha_inicia_display (void);

void inicia_display (void);

void poe_dado_XY (unsigned char, unsigned char,long int);

void poe_texto_XY (unsigned char, unsigned char, char *);

void poe_cursor_XY (unsigned char, unsigned char);
